...
{
        $output = file_get_contents("http://127.0.0.1:10080/update/network/" . $iface);
        if ($output === FALSE) {
                return FALSE;
        }
        return $output;
...
{
        $output = file_get_contents("http://127.0.0.1:10080/update/crontab");
        if ($output === FALSE) {
                return FALSE;
        }
        return $output;
...
{
        $output = file_get_contents("http://127.0.0.1:10080/update/ssh");
        if ($output === FALSE) {
                return FALSE;
        }
        return $output;
...
{
        $output = file_get_contents("http://127.0.0.1:10080/update/sensors");
        if ($output === FALSE) {
                return FALSE;
        }
        return $output;
